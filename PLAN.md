...
| 2026-07-14 | **F14**: Simplifikasi topic binding — topic → sessionId only. cwd, model, mode dari OpenCode API. `/model` + `/mode` persist ke OpenCode via `POST /api/session/{id}/model|agent`. (`92cdc48`). |
